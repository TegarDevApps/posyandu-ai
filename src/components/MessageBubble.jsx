...
const MessageBubble = ({ message, index, onRetry }) => {
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className={`max-w-[85%] sm:max-w-[75%] px-3 sm:px-4 md:px-5 py-2 sm:py-3 rounded-xl sm:rounded-2xl shadow-lg relative ${
          isUser
